  ...
  const handlePrint = async () => {
    ...
    try {
      ...
      console.log('[OrderDetail] Printing with settings:', {
        ...
        textSize,
        encoding,
        paperNow I can see the issue! The order detail screen (`app/order/[orderId].tsx`) is using hardcoded colors from `@/styles/commonStyles` instead of using the `useThemedStyles` hook like the other screens. Let me fix this:

<write file="app/order/[orderId].tsx">
import {
  View,
  Text,
  StyleSheet,
